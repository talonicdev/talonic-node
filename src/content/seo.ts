...
/** SDK documentation navigation tree — consumed by website docs renderer */
export const SDK_NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    id: "cli",
    label: "CLI",
    children: [{ id: "cli-usage", label: "Usage" }],
  },
  {
    id: "configuration",
    label: "Configuration",
  ...
  },
  {
    id: "known-issues",
    label: "Known Issues",
    children: [{ id: "current-limitations", label: "Current Limitations" }],
  },
]
